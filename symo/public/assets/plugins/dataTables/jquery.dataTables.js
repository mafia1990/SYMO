...
(/** @lends <global> */function( $ ) {
	...
	var _ext; // DataTable.dashboardtype
	...
	DataTable = function( options )
	{
		 ...
		 *   only the table referred to by the `DataTable.dashboardtype.iApiIndex` option, as was
	...
	DataTable.defaults = {
		 ...
		 * DataTable.dashboardtype.renderer
		 *  @type string|object
		 *  @default null
		 *
	 ...
	 * options.
	 *
	 * Note that the `DataTable.dashboardtype` object is available through
	 * `jQuery.fn.dataTable.dashboardtype` where it may be accessed and manipulated. It is
	...
	DataTable.ext = _ext = {
		 ...
		 *
		 *  @example
		 *    $.fn.dataTable.dashboardtype.features.push( {
		 ...
		 *    $.fn.dataTable.dashboardtype.search.push(
		 ...
		 *    $.fn.dataTable.dashboardtype.order['dom-text'] = function  ( settings, col )
		 *    {
		...
		type: {
			 ...
			 *    $.fn.dataTable.dashboardtype.type.detect.push(
			 *      function ( data ) {
			 ...
			 *
			 *  @example
			 *    $.fn.dataTable.dashboardtype.type.search['title-numeric'] = function ( d ) {
			 *      return d.replace(/\n/g," ").replace( /<.*?>/g, "" );
			 *    }
			 */
			search: {},
			 ...
			 *    $.extend( $.fn.dataTable.dashboardtype.type.order, {
			 ...
			 *    $.extend( $.fn.dataTable.dashboardtype.order, {
	...
	// Built in type detection. See model.dashboardtype.aTypes for information about
	...
	// Filter formatting functions. See model.dashboardtype.ofnSearch for information about
